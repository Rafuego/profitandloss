...
const INIT_ACCOUNTS = [
  ...
  { id: "a116", name: "Narya VC",     sl: "symphony", leadId: null,  supportIds: [], status: "Launch", type: "Retainer", retainer: 2000, project: 0, weight: 3, startDate: null, endDate: null, notes: "" },
  ...
  { id: "a509", name: "Narya",                  sl: "deck",    leadId: null, pmId: "t20", supportIds: [], status: "Closed",   type: "Project", retainer: 0, project: 10000, weight: 3, depositPaid: false, startDate: "2026-05-01", endDate: "2026-05-31", notes: "PM: Carson. Will convert to Symphony, then primarily on Josh." },
