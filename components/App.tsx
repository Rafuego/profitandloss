...
const INIT_ACCOUNTS = [
  ...
  { id: "a514", name: "Spice VC",               sl: "site",    leadId: "t18", supportIds: [], status: "Active",   type: "Project", retainer: 0, project: 16000, weight: 2, depositPaid: false, startDate: null, endDate: null, notes: "PM: Daniel. $10K original site + $6K expanded scope (animation) worked into the existing site." },
