...
insert into accounts (id, name, sl, lead_id, status, type, retainer, project, weight, start_date, end_date, notes) values
  ...
  ('a13',  'RBL',              'symphony', 't10', 'Closed', 'Retainer', 3000, 0, 3, null, null, ''),
  ...
  ('a116', 'Narya VC',         'symphony', null,  'Launch', 'Retainer', 2000, 0, 3, null, null, ''),
...
insert into accounts (id, name, sl, lead_id, status, type, retainer, project, weight, start_date, end_date, notes) values
  ...
  ('a509', 'Narya',                  'deck',    null,  'Closed',   'Project', 0, 10000, 3, '2026-05-01', '2026-05-31', 'PM: Carson. Will convert to Symphony, then primarily on Josh.'),
